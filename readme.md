...
<p align="center">
  ...
  <img src="https://img.shields.io/github/stars/felipekejo/letmeask?label=stars&message=MIT&color=8257E5&labelColor=000000" alt="Stars">
...
```bash
$ git clone https://github.com/felipekejo/letmeask.git
$ cd letmeask
```
